...
public class MainMenu {
    ...
    public static void Menu2023() {
        ...
        while (x != 100) {     
            ...
            Ministries[] ministries = MinistryLoader.load("src/main/resources/config/ministries23.json");
            Revenues[] revenues = RevenuesLoader.load("src/main/resources/config/revenues23.json");
            Expenses[] expenses = ExpensesLoader.load("src/main/resources/config/expenses23.json");
    ...
    public static void Menu2024() {
        ...
        while (x != 100) {     
            ...
            Ministries[] ministries = MinistryLoader.load("src/main/resources/config/ministries24.json");
            Revenues[] revenues = RevenuesLoader.load("src/main/resources/config/revenues24.json");
            Expenses[] expenses = ExpensesLoader.load("src/main/resources/config/expenses24.json");
